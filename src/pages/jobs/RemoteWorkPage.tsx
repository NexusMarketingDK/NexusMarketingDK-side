...
const RemoteWorkPage: React.FC = () => {
  ...
  const advantages = [
    ...
    'Vi hjælper med oprettelse af CVR/moms nr. og det praktiske den vej'
  ];

  const testimonials = [
    {
      quote: "Jeg har arbejdet hjemmefra for Nexus Marketing i over et år nu, og det giver mig en fantastisk fleksibilitet i hverdagen. Jeg kan strukturere min arbejdsdag omkring mine børns skema og stadig levere gode resultater.",
      name: "Maria Hansen",
      title: "Freelance Mødebooker",
      image: "https://images.pexels.com/photos/774909/pexels-photo-774909.jpeg?auto=compress&cs=tinysrgb&w=600"
    },
    {
      quote: "Som studerende er det perfekt at kunne arbejde hjemmefra og tjene gode penge ved siden af studierne. Nexus Marketing giver mig den fleksibilitet jeg har brug for, samtidig med at jeg udvikler værdifulde salgsevner.",
      name: "Peter Nielsen",
      title: "Freelance Sælger",
  ...
  return (
    <>
      <SEO 
        ...
        description="Få frihed og fleksibilitet med et job som mødebooker eller telesælger hjemmefra. Vi tilbyder attraktiv løn, frie arbejdstider og professionel oplæring inden for telesalg og mødebooking."
        canonical="/jobs/arbejd-hjemmefra"
        keywords="mødebooker job, telesælger job, arbejde hjemmefra, B2B salg, telesalg job, fleksibelt arbejde"
      />

      <HeroSection
        title="Arbejd hjemmefra som Mødebooker & Telesælger"
        subtitle="Få frihed til at arbejde hvor og hvornår du vil, samtidig med at du tjener attraktiv løn. Vi tilbyder de perfekte rammer for dig, der ønsker et fleksibelt job med mødebooking og telesalg hjemmefra."
        ctaText="Ansøg nu"
        ctaLink="#apply"
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">Frihed og fleksibilitet i hverdagen</h2>
              <p className="text-lg text-gray-600">
                Hos Nexus Marketing får du muligheden for at arbejde 100% hjemmefra som mødebooker eller 
                telesælger. Du får friheden til at tilrettelægge din arbejdsdag, som det passer dig, samtidig 
                med at du er en del af et professionelt team med høje ambitioner.
              </p>
            </div>
